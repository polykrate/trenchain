...
export type ParachainTemplateRuntimeRuntimeCall =
  ...
  | { pallet: "Production"; palletCall: PalletProductionCall }
  | { pallet: "Demand"; palletCall: PalletDemandCall }
  | { pallet: "Logistics"; palletCall: PalletLogisticsCall };
...
export type ParachainTemplateRuntimeRuntimeCallLike =
  ...
  | { pallet: "Production"; palletCall: PalletProductionCallLike }
  | { pallet: "Demand"; palletCall: PalletDemandCallLike }
  | { pallet: "Logistics"; palletCall: PalletLogisticsCallLike };
...
export type PalletCampaignCall =
  /**
   * Create a campaign on a given theatre.
   **/
  | {
      name: "CreateCampaign";
      params: {
        name: Bytes;
        theatreId: FixedBytes<32>;
        mode: TcPrimitivesObjectiveCampaignMode;
        maxWarbands: number;
      };
    }
  /**
   * Start the campaign (only creator, transitions Recruiting -> Active).
   **/
  | { name: "StartCampaign"; params: { campaignId: number } }
  /**
   * Advance the campaign turn (root only).
   **/
  | { name: "AdvanceTurn"; params: { campaignId: number } }
  /**
   * Conclude the campaign (creator only).
   **/
  | { name: "ConcludeCampaign"; params: { campaignId: number } }
  /**
   * Enroll a warband into a recruiting campaign.
   **/
  | {
      name: "EnrollWarband";
      params: { campaignId: number; warbandId: number; team: number };
    }
  /**
   * Withdraw a warband from a campaign.
   **/
  | {
  ...
  /**
   * Award VP to a warband (root/battle pallet).
   **/
  | {
      name: "AwardVp";
      params: {
  ...
  /**
   * Mark a warband as eliminated from the campaign (root/battle pallet).
   **/
  | {
      name: "EliminateWarband";
      params: { campaignId: number; warbandId: number };
    }
  /**
   * Check if a victory condition is met (elimination: only one team/player left).
   **/
  | { name: "CheckVictory"; params: { campaignId: number } };
...
export type TcPrimitivesObjectiveCampaignMode =
  | { type: "FreeForAll" }
  | { type: "Teams"; value: { teamCount: number } };

export type TcPrimitivesObjectiveVpReason =
  | "GameWon"
  | "GameLost"
  | "Draw"
  | "KillLeader"
...
export type PalletTheatreCall =
  /**
   * Create a theatre composed of the given regions.
   **/
  | {
      name: "CreateTheatre";
      params: {
  ...
  /**
   * Set objectives for an existing theatre.
   **/
  | {
      name: "SetObjectives";
      params: {
        theatre: FixedBytes<32>;
        primary: TcPrimitivesObjectivePrimaryObjective;
        secondaries: Array<TcPrimitivesObjectiveSecondaryObjective>;
      };
    };
...
export type TcPrimitivesObjectivePrimaryObjective = "Elimination";

export type TcPrimitivesObjectiveSecondaryObjective = {
  kind: TcPrimitivesObjectiveSecondaryObjectiveKind;
  targetTileQ: number;
  targetTileR: number;
  targetResource: FixedBytes<16>;
  vpReward: number;
};

export type TcPrimitivesObjectiveSecondaryObjectiveKind =
  | "KillLeader"
  | "LootResource";
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 **/
export type PalletProductionCall =
  /**
   * Place a building on a tile (player action).
   **/
  | {
      name: "Build";
      params: {
  ...
  /**
   * Seed a transformation recipe (root only).
   **/
  | {
      name: "SeedRecipe";
      params: {
        building: FixedBytes<32>;
        inputs: Array<[FixedBytes<16>, number]>;
        outputs: Array<[FixedBytes<16>, number]>;
      };
    }
  /**
   * Seed terrain yields (root only).
   **/
  | {
      name: "SeedTerrainYield";
      params: { terrainId: number; yields: Array<[FixedBytes<16>, number]> };
    }
  /**
   * Seed pre-computed base production for a region (root only).
   **/
  | {
      name: "SeedBaseProduction";
      params: {
        region: FixedBytes<32>;
        production: Array<[FixedBytes<16>, number]>;
      };
    }
  /**
   * Seed a building on a tile (root only, for initial map setup).
   **/
  | {
      name: "SeedBuilding";
      params: {
...
export type PalletProductionCallLike =
  /**
   * Place a building on a tile (player action).
   **/
  | {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 **/
export type PalletDemandCall =
  /**
   * Set demand for a specific region (root only).
   **/
  | {
      name: "SetRegionDemand";
      params: {
        region: FixedBytes<32>;
        demands: Array<[FixedBytes<16>, number]>;
      };
    }
  /**
   * Set base demand for a faction (root only).
   **/
  | {
      name: "SetFactionBaseDemand";
      params: {
        faction: FixedBytes<16>;
        demands: Array<[FixedBytes<16>, number]>;
      };
...
export type PalletDemandCallLike =
  /**
   * Set demand for a specific region (root only).
   **/
  | {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 **/
export type PalletLogisticsCall =
  /**
   * Register known regions for the logistics loop (root, seeded).
   **/
  | { name: "RegisterRegions"; params: { regions: Array<FixedBytes<32>> } }
  /**
   * Set region adjacency (root, seeded).
   **/
  | {
      name: "SetAdjacency";
      params: { region: FixedBytes<32>; neighbors: Array<FixedBytes<32>> };
    }
  /**
   * Set pre-computed distances between region pairs (root, seeded).
   **/
  | {
      name: "SetDistances";
      params: { pairs: Array<[FixedBytes<32>, FixedBytes<32>, number]> };
    }
  /**
   * Set minimum stock threshold for a resource in a region (root).
   **/
  | {
      name: "SetMinStock";
      params: {
  ...
  /**
   * Manually set stock for a region (root, for testing/seeding).
   **/
  | {
      name: "SeedStock";
      params: {
        region: FixedBytes<32>;
        stock: Array<[FixedBytes<16>, number]>;
      };
    };

export type PalletLogisticsCallLike =
  /**
   * Register known regions for the logistics loop (root, seeded).
   **/
  | { name: "RegisterRegions"; params: { regions: Array<FixedBytes<32>> } }
...
export type ParachainTemplateRuntimeRuntimeEvent =
  ...
  | { pallet: "Production"; palletEvent: PalletProductionEvent }
  | { pallet: "Demand"; palletEvent: PalletDemandEvent }
  | { pallet: "Logistics"; palletEvent: PalletLogisticsEvent };
...
export type PalletCampaignEvent =
  ...
  | { name: "TurnAdvanced"; data: { id: number; turn: number } }
  | { name: "CampaignConcluded"; data: { id: number } }
  | {
      name: "WarbandEnrolled";
      data: { campaignId: number; warbandId: number; team: number };
    }
  | {
  ...
  | {
      name: "WarbandEliminated";
      data: { campaignId: number; warbandId: number };
    }
  | {
      name: "VictoryDeclared";
      data: { campaignId: number; winnerTeam: number };
    };
...
export type PalletTheatreEvent =
  | {
      name: "TheatreCreated";
      data: { code: FixedBytes<32>; regionCount: number };
    }
  | { name: "ObjectivesSet"; data: { theatre: FixedBytes<32> } };
 ...
 * The `Event` enum of this pallet
 **/
export type PalletProductionEvent =
  | {
      name: "BuildingPlaced";
      data: {
        region: FixedBytes<32>;
  ...
  | { name: "RecipeSeeded"; data: { building: FixedBytes<32> } }
  | { name: "TerrainYieldSeeded"; data: { terrainId: number } }
  | { name: "BaseProductionSeeded"; data: { region: FixedBytes<32> } };

/**
 * The `Event` enum of this pallet
 **/
export type PalletDemandEvent =
  | { name: "RegionDemandSet"; data: { region: FixedBytes<32> } }
  | { name: "FactionBaseDemandSet"; data: { faction: FixedBytes<16> } };

/**
 * The `Event` enum of this pallet
 **/
export type PalletLogisticsEvent =
  | { name: "StockUpdated"; data: { region: FixedBytes<32> } }
  | {
      name: "PacketCreated";
      data: {
  ...
  | { name: "AdjacencySet"; data: { region: FixedBytes<32> } }
  | { name: "DistancesSet"; data: { count: number } }
  | {
      name: "MinStockSet";
      data: {
        region: FixedBytes<32>;
  ...
  | { name: "RegionsRegistered"; data: { count: number } };
...
export type PalletTheatreObjectiveSet = {
  primary: TcPrimitivesObjectivePrimaryObjective;
  secondaries: Array<TcPrimitivesObjectiveSecondaryObjective>;
};
...
export type PalletProductionRecipeStorage = {
  inputs: Array<[FixedBytes<16>, number]>;
  outputs: Array<[FixedBytes<16>, number]>;
};
 ...
 * The `Error` enum of this pallet.
 **/
export type PalletProductionError =
  | "TileFull"
  | "BuildingNotFound"
  | "MaxLevelReached";

export type PalletLogisticsPacket = {
  resource: FixedBytes<16>;
  qty: number;
  origin: FixedBytes<32>;
  destination: FixedBytes<32>;
  currentRegion: FixedBytes<32>;
  ttmRemaining: number;
};
 ...
 * The `Error` enum of this pallet.
 **/
export type PalletLogisticsError = "NoPath" | "TooManyRegions";
...
export type ParachainTemplateRuntimeRuntimeError =
  ...
  | { pallet: "Production"; palletError: PalletProductionError }
  | { pallet: "Logistics"; palletError: PalletLogisticsError };
