...
import type {
  ...
  TcPrimitivesObjectiveCampaignMode,
  ...
  TcPrimitivesPoiType,
  TcPrimitivesObjectivePrimaryObjective,
  TcPrimitivesObjectiveSecondaryObjective,
...
> extends GenericChainTx<TxCall<ChainKnownTypes>> {
  ...
  campaign: {
     ...
     *
     * @param {BytesLike} name
     * @param {FixedBytes<32>} theatreId
     * @param {TcPrimitivesObjectiveCampaignMode} mode
     ...
     * @param {number} campaignId
     * @param {number} warbandId
     * @param {TcPrimitivesObjectiveVpReason} reason
     **/
    awardVp: GenericTxCall<
      (
        campaignId: number,
        warbandId: number,
     ...
     * @param {number} warbandId
     **/
    eliminateWarband: GenericTxCall<
      (
        campaignId: number,
        warbandId: number,
      ) => ChainSubmittableExtrinsic<
  ...
  theatre: {
     ...
     * @param {TcPrimitivesObjectivePrimaryObjective} primary
     * @param {Array<TcPrimitivesObjectiveSecondaryObjective>} secondaries
     **/
    setObjectives: GenericTxCall<
      (
  ...
  /**
   * Pallet `Production`'s transaction calls
   **/
  production: {
    /**
     ...
     *
     * @param {FixedBytes<32>} building
     * @param {Array<[FixedBytes<16>, number]>} inputs
     * @param {Array<[FixedBytes<16>, number]>} outputs
     **/
    seedRecipe: GenericTxCall<
      (
        building: FixedBytes<32>,
     ...
     * @param {Array<[FixedBytes<16>, number]>} yields
     **/
    seedTerrainYield: GenericTxCall<
      (
        terrainId: number,
        yields: Array<[FixedBytes<16>, number]>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "Production";
          palletCall: {
     ...
     *
     * @param {FixedBytes<32>} region
     * @param {Array<[FixedBytes<16>, number]>} production
     **/
    seedBaseProduction: GenericTxCall<
      (
        region: FixedBytes<32>,
  ...
  /**
   * Pallet `Demand`'s transaction calls
   **/
  demand: {
    /**
     ...
     *
     * @param {FixedBytes<32>} region
     * @param {Array<[FixedBytes<16>, number]>} demands
     **/
    setRegionDemand: GenericTxCall<
      (
        region: FixedBytes<32>,
     ...
     * @param {Array<[FixedBytes<16>, number]>} demands
     **/
    setFactionBaseDemand: GenericTxCall<
      (
        faction: FixedBytes<16>,
        demands: Array<[FixedBytes<16>, number]>,
      ) => ChainSubmittableExtrinsic<
  ...
  /**
   * Pallet `Logistics`'s transaction calls
   **/
  logistics: {
    /**
     ...
     * @param {Array<FixedBytes<32>>} regions
     **/
    registerRegions: GenericTxCall<
      (regions: Array<FixedBytes<32>>) => ChainSubmittableExtrinsic<
        {
          pallet: "Logistics";
          palletCall: {
            name: "RegisterRegions";
            params: { regions: Array<FixedBytes<32>> };
          };
        },
        ChainKnownTypes
      >
     ...
     *
     * @param {FixedBytes<32>} region
     * @param {Array<FixedBytes<32>>} neighbors
     **/
    setAdjacency: GenericTxCall<
      (
        region: FixedBytes<32>,
        neighbors: Array<FixedBytes<32>>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "Logistics";
          palletCall: {
     ...
     *
     * @param {Array<[FixedBytes<32>, FixedBytes<32>, number]>} pairs
     **/
    setDistances: GenericTxCall<
      (
        pairs: Array<[FixedBytes<32>, FixedBytes<32>, number]>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "Logistics";
          palletCall: {
     ...
     *
     * @param {FixedBytes<32>} region
     * @param {FixedBytes<16>} resource
     * @param {number} threshold
     **/
    setMinStock: GenericTxCall<
      (
        region: FixedBytes<32>,
     ...
     *
     * @param {FixedBytes<32>} region
     * @param {Array<[FixedBytes<16>, number]>} stock
     **/
    seedStock: GenericTxCall<
      (
        region: FixedBytes<32>,
